...
class ClientQuoteTable extends LivewireTableComponent
{
    ...
    public function configure(): void
    {
        ...
        $this->setThAttributes(function (Column $column) {
            if ($column->isField('final_amount')) {
                return [
                    'class' => app()->getLocale() == 'ar' ? 'd-flex justify-content-start' : 'd-flex justify-content-end',
                ];
            }
    ...
    public function builder(): Builder
    {
        ...
        return Quote::with(['client.user.media'])->select('quotes.*')->where('client_id', $clientId)
