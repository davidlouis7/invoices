...
return [
    ...
    */
    ...
    'date_format' => ':attribute لا تتوافق مع التنسيق :format.',
    'different' => 'يجب أن تكون :attribute و :other مختلفة.',
    'digits' => 'يجب أن تكون :attribute أرقام :digits.',
    ...
    'max' => [
        ...
        'file' => 'لا يجوز أن تكون :attribute أكبر من :value كيلوبايت.',
    ...
    'required_unless' => 'حقل :attribute مطلوب إلا إذا كا :other في :values.',
    'required_with' => 'حقل :attribute مطلوب عندما :values موجودة.',
    'required_with_all' => 'يكون حقل :attribute مطلوبًا عندما تكون :values موجودة.',
    ...
    'prohibited_unless' => 'يُحظر: حقل :attribute ما لم :other في :values.',
    ...
    'starts_with' => 'يجب أن تبدأ :attribute بأحد :values',
