            ...
            <table class="table table-striped box-shadow-none mt-4" id="billTbl">
                ...
                <tr class="tax-tr">
                    ...
                    <td class="table__item-desc w-25">
                        {{ Form::select('product_id[]', $products, null, ['class' => 'form-select product-quote io-select2','required','placeholder'=>__('Select Product or Enter free text'),'data-control' => 'select2']) }}
                    </td>
                    <td class="table__qty">
