...
@section('content')
    <div class="d-flex flex-column flex-column-fluid align-items-center mt-12 p-4">
            ...
            @if(Session::has('status'))
                <div class="alert alert-success custom-message">
                    <div class="d-flex text-white align-items-center">
                        <svg class="svg-inline--fa fa-face-smile {{app()->getLocale() == 'ar' ? 'ms-5' : 'me-5'}}" aria-hidden="true" focusable="false"
                        ...
                        <div>
                            <span class="text-white">{{__('We have emailed your password reset link!')}}</span>
                        </div>
                    </div>
                </div>
            @endif
        ...
        <div class="bg-white rounded-15 shadow-md width-540 px-5 px-sm-7 py-10 mx-auto">
            ...
            <div class="fw-bold fs-4 mb-5 text-center">{{__('Enter your email to reset your password.')}}</div>
            <div
