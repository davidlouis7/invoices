                                ...
                                <div class="card-body d-flex flex-column p-0">
                                    ...
                                    <div class="flex-grow-1 card-p pb-0">
                                        <div class="d-flex flex-stack flex-wrap">
                                            <div class="{{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="d-flex flex-column w-100 {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
                                                        <div class="d-flex flex-stack mb-2">
                                                            <span class="text-muted {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}} fs-7 fw-bold">50%</span>
                                                        </div>
                                        ...
                                        <div class="d-flex justify-content-end flex-shrink-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="d-flex flex-column w-100 {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
                                                        <div class="d-flex flex-stack mb-2">
                                                            <span class="text-muted {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}} fs-7 fw-bold">70%</span>
                                                        </div>
                                                        <div class="progress h-6px w-100">
                                           ...
                                           class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="d-flex flex-column w-100 {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
                                                        <div class="d-flex flex-stack mb-2">
                                                            <span class="text-muted {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}} fs-7 fw-bold">60%</span>
                                                        </div>
                                                        <div class="progress h-6px w-100">
                                    ...
                                    <span class="svg-icon svg-icon-3">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="d-flex flex-column w-100 {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
                                                        <div class="d-flex flex-stack mb-2">
                                                            <span class="text-muted {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}} fs-7 fw-bold">90%</span>
                                                        </div>
                                                        <div class="progress h-6px w-100">
                            ...
                            <div class="card card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                        ...
                                        <!--end::Icon-->
                                        <!--begin::Title-->
                                        <div class="flex-grow-1 {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="d-flex flex-stack mb-5">
                                            <!--begin::Section-->
                                            <div class="d-flex align-items-center {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
                                                <!--begin::Symbol-->
                                        ...
                                        <div class="tab-pane fade show active" id="kt_table_widget_5_tab_1">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="symbol symbol-45px {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
                                                                    <span class="symbol-label">
                                                                        <img src="{{ asset('web/media/svg/brand-logos/plurk.svg') }}"
                                                                             class="h-50 align-self-center" alt=""/>
                                                                    </span>
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <div class="fv-row">
                                                ...
                                                <label class="d-flex flex-stack mb-5 cursor-pointer">
                                                    <!--begin:Label-->
                                                    <span class="d-flex align-items-center {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}}">
															<!--begin:Icon-->
                ...
                <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="nav-group nav-group-outline mx-auto" data-kt-buttons="true">
                            <a href="#"
                               class="btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3 {{app()->getLocale() == 'ar' ? 'ms-2' : 'me-2'}} active"
