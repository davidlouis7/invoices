<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::select('category_id', $categories ,null, ['id'=>'categoryId', 'class' => 'form-select io-select2 ',
            'placeholder' => __('messages.product.category'), 'required', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
        ...
        <div class="mb-3" io-image-input="true">
            ...
            <div class="d-block">
                <div class="image-picker">
                    <div class="image previewImage" id="previewImage" {{ $styleCss }}="background-image: url('{{ !empty($product->product_image) ?
